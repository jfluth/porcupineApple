...
entity pix_clk_25MHz_pix_clk_25MHz_clk_wiz is
  port (
...
end pix_clk_25MHz_pix_clk_25MHz_clk_wiz;

architecture STRUCTURE of pix_clk_25MHz_pix_clk_25MHz_clk_wiz is
  signal clk_in1_pix_clk_25MHz : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
    port map (
      I => clkfbout_pix_clk_25MHz,
      O => clkfbout_buf_pix_clk_25MHz
    );
clkin1_ibufg: unisim.vcomponents.IBUF
    ...
    port map (
      I => clk_in1,
      O => clk_in1_pix_clk_25MHz
    );
clkout1_buf: unisim.vcomponents.BUFG
    port map (
      I => pix_clk_25MHz_pix_clk_25MHz,
      O => pix_clk_25MHz
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    ...
    port map (
      CLKFBIN => clkfbout_buf_pix_clk_25MHz,
      CLKFBOUT => clkfbout_pix_clk_25MHz,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_pix_clk_25MHz,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => pix_clk_25MHz_pix_clk_25MHz,
...
architecture STRUCTURE of pix_clk_25MHz is
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of STRUCTURE : architecture is true;
begin
inst: entity work.pix_clk_25MHz_pix_clk_25MHz_clk_wiz
    port map (
      clk_in1 => clk_in1,
